...
Möchte man hingegen nur ein bestimmtes ||Ziel|| ausführen,
kann man dieses mit |make <ZIEL>| direkt ansteuern,
beispielsweise |make zip|.

Diese |makefile|-Datei lässt sich nach Belieben ergänzen und verändern,
