...
und \enquote{Quelle} (s.\,u.) zu durchdringen \parencites{peschel-findelsen}{}
...
werden mit (in diesem Fall) dem Präfix gekoppelt.
Somit spart man sich manche Tipparbeit.
...
die wir nun in eine \texttt{makefile}-Datei schreiben.
...
Diese \texttt{makefile}-Datei lässt sich nach Belieben ergänzen und verändern,
